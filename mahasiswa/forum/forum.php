...
// Cek akses
if ($role === 'dosen' && !is_dosen_of_class($pdo, $_SESSION['user_id'], $class_id)) die("Akses ditolak.");
if ($role === 'mahasiswa' && !is_mahasiswa_in_class($pdo, $_SESSION['user_id'], $class_id)) die("Akses ditolak.");
